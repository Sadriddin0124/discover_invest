      ...
      <div className='w-[100%] border-l-2 border-l-purple-600 flex flex-col gap-[150px]'>
        {
            data?.map((item,index)=> {
                return <div key={index} className='flex gap-[20px] justify-between flex-col-reverse lg:flex-row relative'>
                    <div className='w-[100%] lg:w-[500px] px-[20px] pr-0 sm:px-[30px] flex flex-col gap-[30px]'>
                    ...
                    <div className='xl:w-[700px] w-[100%] lg:w-[600px] lg:ml-0 ml-[40px] h-[250px] sm:h-[400px] lg:h-[300px] xl:h-[400px] relative border border-purple-600 cursor-pointer'>
