...
const AboutHeader = () => {
  ...
  return (
    <header className="w-[100%] min-h-[120vh] flex justify-start items-center relative py-[100px] px-[100px]">
      ...
      />
      <div className="flex flex-col items-start gap-[20px] max-w-[600px] text-white">
        <h1 className="text-[80px] font-[600]">{title}</h1>
