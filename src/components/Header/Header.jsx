...
const Header = () => {
  ...
  return (
    <header className='w-[100%] h-[94vh] relative flex items-center justify-center'>
      ...
      <div className='px-[30px] relative justify-center items-center z-10 sm:ml-[100px] text-white w-[100%] max-w-[700px] flex flex-col sm:items-start gap-[30px]'>
